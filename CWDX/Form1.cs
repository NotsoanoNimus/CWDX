...
namespace CWDX {
    public partial class TransmitForm : Form {
        ...
        public TransmitForm() {
            ...
            var wavFormat = new WaveAudioFormat(44100, 16, 1);
            ...
            WaveAudioTools.ChangeVolume(40.0, ref chord); // testing volume change
            ...
            using(var finalFile = new WaveStream(new WaveAudioFormat(44100, 16, 1), WaveGenerator.ToByteArray(chord.ToArray()))) {
